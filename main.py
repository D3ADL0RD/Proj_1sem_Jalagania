...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.btn_open_dialog = tk.Button(toolbar, text='Добавить игрока',
    ...
    def update_record(self, user_id, name, sex, old, score):
        self.db.cur.execute("""UPDATE users SET user_id=?, name=?, sex=?, 
old=?, score=? WHERE user_id=?""",
...
class Update(Child):
    ...
    def init_edit(self):
        ...
        self.view.update_record(self.entry_description.get(),
